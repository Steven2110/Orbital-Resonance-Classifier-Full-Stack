...
function App() {
  ...
  const translations = {
    EN: {
      title: 'Orbital Resonance Classifier',
      subtitle: 'Upload orbital data files and classify resonance patterns',
      help: 'Help',
      helpTitle: 'How to Use Orbital Resonance Classifier',
      ...
      column2: 'Column 2: Ф1 (Phi 1)',
      column3: 'Column 3: Ф2 (Phi 2)',
      column4: 'Column 4: Ф3 (Phi 3)',
      column5: 'Column 5: Ф4 (Phi 4)',
      column6: 'Column 6: Ф5 (Phi 5)',
    ...
    RU: {
      title: 'Классификатор орбитального резонанса',
      subtitle: 'Загрузите файлы орбитальных данных и классифицируйте резонансные структуры',
      help: 'Помощь',
      ...
      column2: 'Столбец 2: Ф1 (Фи 1)',
      column3: 'Столбец 3: Ф2 (Фи 2)',
      column4: 'Столбец 4: Ф3 (Фи 3)',
      column5: 'Столбец 5: Ф4 (Фи 4)',
      column6: 'Столбец 6: Ф5 (Фи 5)',
      ...
      step3: 'Система создаст диаграммы рассеяния для каждого столбца Ф',
